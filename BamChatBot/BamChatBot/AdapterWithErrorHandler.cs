...
namespace BamChatBot
{
	public class AdapterWithErrorHandler : BotFrameworkHttpAdapter
	{
		...
		{
			new CardAction() { Title = "To contact RPA support click here", Text = "To contact RPA support click here", Type = ActionTypes.PostBack, Value = "RPASupport@bayview.com", DisplayText="openEmail" }
